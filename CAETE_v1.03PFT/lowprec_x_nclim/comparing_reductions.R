...
cmass_kg_PFT <-raster("/home/bianca/paper_mestrado_codes_results/CAETEv1.0_3PFT/lowprec_x_nclim/cmass_reduction_area_pft.tif")

cmass_kg_PLS<-raster("/home/bianca/paper_mestrado_codes_results/CAETEv1.0_3PFT/lowprec_x_nclim/cmass_reduction_area_pls.tif")
